...
public class MainFragment extends Fragment implements CvCameraViewListener2 {
    ...
    public ArrayList<Bitmap> calculateObjectResults() {
        ...
        //Iterate through the first input image and place an image object inside.
        int fraction = 20;
...
//        Imgproc.cvtColor(input,input,Imgproc.COLOR_BGRA2BGR);
        ...
        for (int i = 1; i < images.size(); i++) {
            ...
            if (pts1Mat.rows() >= 4 || pts2Mat.rows() >= 4) {
                ...
                //Iterate through the input image and check if the corresponding homography image has an object projected at the specific pixel.
                int startFraction = 5;
